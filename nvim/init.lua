...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- Removed stylua due to LSP compatibility issues
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        -- lua = { 'stylua' }, -- Disabled due to LSP compatibility issues
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      local function clear_lsp_reference_highlights()
        for _, group in ipairs({ 'LspReferenceText', 'LspReferenceRead', 'LspReferenceWrite' }) do
          vim.api.nvim_set_hl(0, group, { link = 'Normal' })
        end
      end

      clear_lsp_reference_highlights()

      local augroup = vim.api.nvim_create_augroup('crca-catppuccin-overrides', { clear = true })
      vim.api.nvim_create_autocmd('ColorScheme', {
        group = augroup,
        pattern = '*',
        callback = clear_lsp_reference_highlights,
      })
    end,
  },
